...
def getPlaylist():
    ...
    if request.method == 'POST':     
        ...
        if user_premium_status != "premium":
            return render_template('getTracks.html', track_data=track_data, playlist_data = playlist_data, devices = devices, user_premium_status= user_premium_status)
...
def createPlaylist():
    ...
    sp.user_playlist_add_tracks(user=user_id, playlist_id=created_playlistID, tracks = uris)
