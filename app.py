...
def createPlaylist():
    ...
    created_playlistID = sp.user_playlist_create(user=user_id, name="Better Shuffle Results", public=True, collaborative=False, description="Playlist automatically generated by bettershuffle.com")['id']
